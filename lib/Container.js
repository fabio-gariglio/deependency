...
const ObjectConstructorRegistrationService = require(
  './registrationServices/ObjectConstructorRegistrationService'
);
...
module.exports = function Container() {
  ...
  _registrationServiceCatalog.add(new ObjectConstructorRegistrationService());
